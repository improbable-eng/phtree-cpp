# The following is a fork of the upstream bazel rules from tools/build_defs/repo/http.bzl that fixes
# netrc file lookup on Windows.
...
load(
    # BEGIN IMPROBABLE EDIT: use upstream utils.bzl
...
def _get_auth(ctx, urls):
    ...
    # BEGIN IMPROBABLE EDIT: lookup netrc file on Windows
